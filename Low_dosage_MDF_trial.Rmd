...
fish_data <- read.csv("/Users/shashankgupta/Desktop/ImprovAFish/FInal_Figures/Metrics.csv", row.names = 1)
...
host_gut_rawCounts_url <- paste0(base_url, "Transcriptomics/host_gut_count.txt")
sample_info_url <- paste0(base_url, "Transcriptomics/sample_info.csv")
...
rds_file <- "Metatranscriptomics/dds_metatranscriptomics.rds"
